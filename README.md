...
```
cd existing_repo
git remote add origin https://gitlab.com/tanda-market/tankda-backend.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/tanda-market/tankda-backend/-/settings/integrations)
